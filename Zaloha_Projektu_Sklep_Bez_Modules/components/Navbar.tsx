...
const BOOKING_PAGES: string[] = ['/kontakt', '/rezervace'];
...
function handleCrossPageNav(e: React.MouseEvent<HTMLAnchorElement>, href: string): void {
  if (href.startsWith('#')) {
    e.preventDefault();
...
export default function Navbar() {
  ...
  const cta: CtaConfig = isBookingPage
  ...
  function getLinkClick(href: string): (e: React.MouseEvent<HTMLAnchorElement>) => void {
    return isHomepage
