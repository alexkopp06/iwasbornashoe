...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      /* Parallax jen na desktopu — na mobilu zbytečně zatěžuje GPU */
      const mm = gsap.matchMedia();
      mm.add('(min-width: 768px)', () => {
        /* Obrázek parallax — pomalejší posun než scroll */
  ...
  /* ── (Video autoplay odstraněn — Hero nyní používá statický obrázek) ── */
  ...
  return (
    ...
    >
      ...
      {/* ════════════════════════════════════════════════
          HERO POZADÍ — responzivní obrázek
          ════════════════════════════════════════════════ */}
      <div
        ref={bgRef}
      ...
      >
        <picture>
          {/* Mobilní verze — menší soubor pro úzké displeje */}
          <source
            srcSet="/hero-cellar-mobile.webp"
            media="(max-width: 767px)"
            type="image/webp"
          />
          {/* Desktop / tablet — plná kvalita */}
          <source
            srcSet="/hero-cellar.webp"
            media="(min-width: 768px)"
            type="image/webp"
          />
          <img
            ref={imgRef}
            src="/hero-cellar.webp"
            alt="Vinný sklípek Rustikal — degustace s přáteli"
        ...
        {/* Gradient fallback — viditelný než se načte obrázek */}
        <div
